    ...
    <header>
      ...
      <div class="header_btn-container">
        ...
        <div class="user-btn-container">
          <a href="../frontend/templates/login.php" target="_blank" rel="noopener">
        ...
        <div class="products">
          <div class="product">
            <a href="#">
              <div class="media-container">
                <img
                  src="watermark/cover_silksong.jpg"
                  alt="Hollow Knight: Silksong"
                  class="product-image"
                />
                <video
                  src="video/hollow_knight_silksong.mp4"
                  muted
                  preload="none"
                  class="product-video"
                ></video>
          ...
          <div class="product">
            <a href="#">
              <div class="media-container">
                <img
                  src="watermark/cover_celeste.jpg"
                  alt="Celeste"
                  class="product-image"
                />
                <video
                  src="video/celeste.mp4"
                  muted
                  preload="none"
                  class="product-video"
                ></video>
          ...
          <div class="product" id="baldurs-gate">
            <a href="#">
              <div class="media-container">
                <img
                  src="watermark/cover_baldurs_gate.jpg"
                  alt="Baldur's Gate III"
                  class="product-image"
                />
                <video
                  src="video/baldurs_gate.mp4"
                  muted
                  preload="none"
                  class="product-video"
                ></video>
      ...
      <section class="offers">
        ...
        <div class="products">
          ...
          <div class="product">
            <a href="#">
              <img
                src="watermark/cover_pokemon_leyends_ZA.jpg"
                alt="Pokémon Leyendas Z/A"
              />
              <div class="product-text">
